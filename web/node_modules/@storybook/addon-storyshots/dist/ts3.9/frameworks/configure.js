...
function configure(options) {
    ...
    if (preview) {
        ...
        var _c = jest.requireActual(preview), parameters = _c.parameters, decorators = _c.decorators, globals = _c.globals, globalTypes = _c.globalTypes, argsEnhancers = _c.argsEnhancers, argTypesEnhancers = _c.argTypesEnhancers;
        if (decorators) {
        ...
        if (argsEnhancers) {
            argsEnhancers.forEach(function (enhancer) { return storybook.addArgsEnhancer(enhancer); });
        }
