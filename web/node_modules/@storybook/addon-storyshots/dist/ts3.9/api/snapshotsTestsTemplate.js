...
var describe = global_1.default.describe, it = global_1.default.it;
    ...
    if (asyncJest === true) {
        it(name, function () {
            return new Promise(function (resolve, reject) {
                return testMethod(__assign({ done: function (error) { return (error ? reject(error) : resolve()); }, story: item, context: context }, testMethodParams));
            });
        }, testMethod.timeout);
    }
    else {
